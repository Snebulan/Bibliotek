            ...
            modelBuilder.Entity("Bibliotek.Models.Loan", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, BookID = 1, DateLoan = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), DateReturn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), MemberID = 1 }
                    );
                });
